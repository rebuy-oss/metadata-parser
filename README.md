...
> [!NOTE]
> This project is based on the original work of [liip/metadata-parser](https://github.com/liip/metadata-parser). This repository is the actively maintained continuation of that project.
